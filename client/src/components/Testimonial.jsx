...
const Testimonial = () => {
  return (
        ...
        <div className='flex flex-col md:flex-row justify-center items-center gap-2 mt-5 md:mt-10'>
            ...
            <p className="text-center text-[15px] mt-3 text-gray-500">"I've used many booking platforms before, but none compare to the personalized experience and attention to detail that CarRental provides."</p>
        </div>
